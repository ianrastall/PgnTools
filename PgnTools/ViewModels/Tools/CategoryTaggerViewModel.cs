...
/// </summary>
public partial class CategoryTaggerViewModel : BaseViewModel, IDisposable
{
    private readonly ICategoryTaggerService _categoryTaggerService;
    ...
    public CategoryTaggerViewModel(
        ICategoryTaggerService categoryTaggerService,
        IWindowService windowService,
        IAppSettingsService settings)
    {
        _categoryTaggerService = categoryTaggerService;
