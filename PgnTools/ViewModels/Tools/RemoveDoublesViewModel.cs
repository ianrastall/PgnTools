...
/// </summary>
public partial class RemoveDoublesViewModel : BaseViewModel, IDisposable
{
    private readonly IRemoveDoublesService _removeDoublesService;
    ...
    public RemoveDoublesViewModel(
        IRemoveDoublesService removeDoublesService,
        IWindowService windowService,
        IAppSettingsService settings)
    {
        _removeDoublesService = removeDoublesService;
