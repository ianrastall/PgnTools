...
/// </summary>
public partial class StockfishNormalizerViewModel : BaseViewModel, IDisposable
{
    private readonly IStockfishNormalizerService _stockfishNormalizerService;
    ...
    public StockfishNormalizerViewModel(
        IStockfishNormalizerService stockfishNormalizerService,
        IWindowService windowService,
        IAppSettingsService settings)
    {
        _stockfishNormalizerService = stockfishNormalizerService;
