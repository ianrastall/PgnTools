...
/// <summary>
/// ViewModel for the WPF Settings tab: accent color plus default folders that
/// the downloader and analysis tools read as their starting locations.
/// </summary>
    ...
    IWindowService windowService) : BaseViewModel, IInitializable, IDisposable
{
    ...
    public void Initialize()
    {
        ...
        StatusMessage = "Personalize appearance and default folders.";

        AccentOptions = new ObservableCollection<AccentOption>(AccentColorManager.GetAccentOptions());
        LoadState();
    }
    ...
    {
        // Always apply the visual accent, even while loading the saved choice.
        ...
        _settings.SetValue(AppSettingsKeys.AccentColor, value?.Key ?? "System");
    }
