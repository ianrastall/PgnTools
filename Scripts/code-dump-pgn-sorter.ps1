[CmdletBinding()]
param(
    [string]$OutputPath = "..\Context\PgnSorter_Context.txt",
    [string]$ExtraManifestPath = "",
    [string[]]$Tags = @("PGNSORTER"),
    [switch]$TaggedOnly,
...
$manualFiles = @(
    "Docs\PgnSorterService.md"
    "PgnTools\Services\PgnSorterService.cs"
    "PgnTools\ViewModels\Tools\PgnSorterViewModel.cs"
    "PgnTools\Views\Tools\PgnSorterPage.xaml"
    "PgnTools\Views\Tools\PgnSorterPage.xaml.cs"
...
$autoPatterns = @(
    "PgnTools\Services\*PgnSorter*.cs"
    "PgnTools\ViewModels\Tools\*PgnSorter*.cs"
    "PgnTools\Views\Tools\*PgnSorter*.xaml"
    "PgnTools\Views\Tools\*PgnSorter*.xaml.cs"
)
...
if ([string]::IsNullOrWhiteSpace($ExtraManifestPath)) {
    $ExtraManifestPath = Join-Path $ScriptLocation "code-dump-pgn-sorter.extra.txt"
}
...
try {
    $writer.WriteLine("# Context Dump: PGN Sorter")
