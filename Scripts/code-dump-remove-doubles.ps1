[CmdletBinding()]
param(
    [string]$OutputPath = "..\Context\RemoveDoubles_Context.txt",
    [string]$ExtraManifestPath = "",
    [string[]]$Tags = @("REMOVEDOUBLES"),
    [switch]$TaggedOnly,
...
$manualFiles = @(
    "Docs\RemoveDoublesService.md"
    "PgnTools\Services\RemoveDoublesService.cs"
    "PgnTools\ViewModels\Tools\RemoveDoublesViewModel.cs"
    "PgnTools\Views\Tools\RemoveDoublesPage.xaml"
    "PgnTools\Views\Tools\RemoveDoublesPage.xaml.cs"
...
$autoPatterns = @(
    "PgnTools\Services\*RemoveDoubles*.cs"
    "PgnTools\ViewModels\Tools\*RemoveDoubles*.cs"
    "PgnTools\Views\Tools\*RemoveDoubles*.xaml"
    "PgnTools\Views\Tools\*RemoveDoubles*.xaml.cs"
)
...
if ([string]::IsNullOrWhiteSpace($ExtraManifestPath)) {
    $ExtraManifestPath = Join-Path $ScriptLocation "code-dump-remove-doubles.extra.txt"
}
...
try {
    $writer.WriteLine("# Context Dump: Remove Doubles")
