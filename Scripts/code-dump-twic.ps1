[CmdletBinding()]
param(
    [string]$OutputPath = "..\Context\Twic_Context.txt",
...
$manualFiles = @(
    "Docs\TwicDownloaderService.md",
    "PgnTools\Services\ITwicDownloaderService.cs",
    "PgnTools\Services\TwicDownloaderService.cs",
    "PgnTools\ViewModels\Tools\TwicDownloaderViewModel.cs",
    "PgnTools\Views\Tools\TwicDownloaderPage.xaml",
    "PgnTools\Views\Tools\TwicDownloaderPage.xaml.cs",
    "PgnTools\Helpers\FileReplacementHelper.cs",
    "PgnTools\Helpers\FilePickerHelper.cs"
)

$autoPatterns = @(
    "PgnTools\Services\*Twic*.cs",
    "PgnTools\ViewModels\Tools\*Twic*.cs",
    "PgnTools\Views\Tools\*Twic*.xaml",
    "PgnTools\Views\Tools\*Twic*.xaml.cs"
)
...
if ([string]::IsNullOrWhiteSpace($ExtraManifestPath)) {
    $ExtraManifestPath = Join-Path $ScriptLocation "code-dump-twic.extra.txt"
}
...
try {
    $writer.WriteLine("# Context Dump: TWIC Downloader")
