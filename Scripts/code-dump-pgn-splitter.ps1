[CmdletBinding()]
param(
    [string]$OutputPath = "..\Context\PgnSplitter_Context.txt",
    [string]$ExtraManifestPath = "",
    [string[]]$Tags = @("PGNSPLITTER"),
    [switch]$TaggedOnly,
...
$manualFiles = @(
    "Docs\PgnSplitterService.md"
    "PgnTools\Services\PgnSplitterService.cs"
    "PgnTools\ViewModels\Tools\PgnSplitterViewModel.cs"
    "PgnTools\Views\Tools\PgnSplitterPage.xaml"
    "PgnTools\Views\Tools\PgnSplitterPage.xaml.cs"
...
$autoPatterns = @(
    "PgnTools\Services\*PgnSplitter*.cs"
    "PgnTools\ViewModels\Tools\*PgnSplitter*.cs"
    "PgnTools\Views\Tools\*PgnSplitter*.xaml"
    "PgnTools\Views\Tools\*PgnSplitter*.xaml.cs"
)
...
if ([string]::IsNullOrWhiteSpace($ExtraManifestPath)) {
    $ExtraManifestPath = Join-Path $ScriptLocation "code-dump-pgn-splitter.extra.txt"
}
...
try {
    $writer.WriteLine("# Context Dump: PGN Splitter")
