[CmdletBinding()]
param(
    [string]$OutputPath = "..\Context\PgnMentor_Context.txt",
    [string]$ExtraManifestPath = "",
    [string[]]$Tags = @("PGNMENTOR"),
    [switch]$TaggedOnly,
...
$manualFiles = @(
    "Docs\PgnMentorDownloaderService.md",
    "PgnTools\Services\IPgnMentorDownloaderService.cs",
    "PgnTools\Services\PgnMentorDownloaderService.cs",
    "PgnTools\ViewModels\Tools\PgnMentorDownloaderViewModel.cs",
    "PgnTools\Views\Tools\PgnMentorDownloaderPage.xaml",
    "PgnTools\Views\Tools\PgnMentorDownloaderPage.xaml.cs",
...
$autoPatterns = @(
    "PgnTools\Services\*PgnMentor*.cs",
    "PgnTools\ViewModels\Tools\*PgnMentor*.cs",
    "PgnTools\Views\Tools\*PgnMentor*.xaml",
    "PgnTools\Views\Tools\*PgnMentor*.xaml.cs"
)
...
if ([string]::IsNullOrWhiteSpace($ExtraManifestPath)) {
    $ExtraManifestPath = Join-Path $ScriptLocation "code-dump-pgnmentor.extra.txt"
}
...
try {
    $writer.WriteLine("# Context Dump: PGN Mentor")
