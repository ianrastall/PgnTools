[CmdletBinding()]
param(
    [string]$OutputPath = "..\Context\StockfishNormalizer_Context.txt",
    [string]$ExtraManifestPath = "",
    [string[]]$Tags = @("STOCKFISHNORMALIZER"),
    [switch]$TaggedOnly,
...
$manualFiles = @(
    "Docs\StockfishNormalizerService.md"
    "PgnTools\Services\StockfishNormalizerService.cs"
    "PgnTools\ViewModels\Tools\StockfishNormalizerViewModel.cs"
    "PgnTools\Views\Tools\StockfishNormalizerPage.xaml"
    "PgnTools\Views\Tools\StockfishNormalizerPage.xaml.cs"
...
$autoPatterns = @(
    "PgnTools\Services\*StockfishNormalizer*.cs"
    "PgnTools\ViewModels\Tools\*StockfishNormalizer*.cs"
    "PgnTools\Views\Tools\*StockfishNormalizer*.xaml"
    "PgnTools\Views\Tools\*StockfishNormalizer*.xaml.cs"
)
...
if ([string]::IsNullOrWhiteSpace($ExtraManifestPath)) {
    $ExtraManifestPath = Join-Path $ScriptLocation "code-dump-stockfish-normalizer.extra.txt"
}
...
try {
    $writer.WriteLine("# Context Dump: Stockfish Normalizer")
