[CmdletBinding()]
param(
    [string]$OutputPath = "..\Context\PgnJoiner_Context.txt",
    [string]$ExtraManifestPath = "",
    [string[]]$Tags = @("PGNJOINER"),
    [switch]$TaggedOnly,
...
$manualFiles = @(
    "Docs\PgnJoinerService.md"
    "PgnTools\Services\PgnJoinerService.cs"
    "PgnTools\ViewModels\Tools\PgnJoinerViewModel.cs"
    "PgnTools\Views\Tools\PgnJoinerPage.xaml"
    "PgnTools\Views\Tools\PgnJoinerPage.xaml.cs"
...
$autoPatterns = @(
    "PgnTools\Services\*PgnJoiner*.cs"
    "PgnTools\ViewModels\Tools\*PgnJoiner*.cs"
    "PgnTools\Views\Tools\*PgnJoiner*.xaml"
    "PgnTools\Views\Tools\*PgnJoiner*.xaml.cs"
)
...
if ([string]::IsNullOrWhiteSpace($ExtraManifestPath)) {
    $ExtraManifestPath = Join-Path $ScriptLocation "code-dump-pgn-joiner.extra.txt"
}
...
try {
    $writer.WriteLine("# Context Dump: PGN Joiner")
